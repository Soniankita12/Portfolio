const Intro = () => {
  return (
    <div className="h-[80vh] bg-Primary flex flex-col items-start justify-center gap-8">
      ...
      <h1 className="text-4xl text-secondary font-semibold">Ankita Soni</h1>
      <h1 className="text-4xl text-tretiary font-semibold">
      ...
      <button className="border-2 border- text-white px-10 py-5 ">Get Started</button>
    </div>
  );
};
